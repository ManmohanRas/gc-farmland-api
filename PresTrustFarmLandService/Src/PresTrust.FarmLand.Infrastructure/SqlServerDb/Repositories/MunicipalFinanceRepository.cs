...
public class MunicipalFinanceRepository : IMunicipalFinanceRepository
{
    ...
    public async Task<List<FarmMunicipalFinanceEntity>> GetMunicipalFinanceDetails(int agencyId, bool useYearFilter = false)
    {
        using var conn = context.CreateConnection();
        var sqlCommand = new GetMunicipalFinanceDetailsSqlCommand();
        return (await conn.QueryAsync<FarmMunicipalFinanceEntity>(sqlCommand.ToString(),
    ...
    public async Task<int> SaveMunicipalFinanceDetailsAsync(FarmMunicipalFinanceEntity municipalFinance)
    {
    ...
    private async Task<int> CreateMunicipalFinanceAsync(FarmMunicipalFinanceEntity municipalFinance)
    {
        int result = default;
    ...
    private async Task<int> UpdateMunicipalFinanceAsync(FarmMunicipalFinanceEntity municipalFinance)
    {
        using var conn = context.CreateConnection();
