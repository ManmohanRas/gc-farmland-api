    ...
    private async Task<FarmEsmtExceptionsEntity> UpdateAsync(FarmEsmtExceptionsEntity exceptionsDetails)
    {
        ...
        await conn.ExecuteAsync(sqlCommand.ToString(),
            ...
            param: new
            {
                ...
                @p_ExceptionNonServable = exceptionsDetails.ExceptionNonServable,
                @P_ExceptionTotalNonServable = exceptionsDetails.ExceptionTotalNonServable,
                @p_ExceptionServable = exceptionsDetails.ExceptionServable,
                @p_ExceptionTotalServable = exceptionsDetails.ExceptionTotalServable,
