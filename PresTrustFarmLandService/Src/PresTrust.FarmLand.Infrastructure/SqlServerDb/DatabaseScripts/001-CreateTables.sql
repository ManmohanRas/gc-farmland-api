...
BEGIN TRY
   ...
   ---Document Type
	...
	--Farm Term App Deed Location(Bridge b/w deed and location)
	...
	--Farm Municipal Trust Fund Permitted Uses
	-- Drop Table
	...
	CREATE TABLE [Farm].[FarmEsmtAppOwnerDetails](
		...
		[AtMailingAddress]				[varchar](4000)						NULL,
		[ATFirmName]					[varchar](4000)						NULL,
	...
	CREATE TABLE [Farm].[FarmEsmtExceptionsAttachmentB](
	   ...
	   [NonAgriExceptionArea]         [varchar](4000)                       NULL,
   ...
   IF OBJECT_ID('[Farm].[FarmEsmtAttachmentC]') IS NOT NULL
	...
	--Farm Esmt AttachmentD SourceType
	-- Drop Table
	...
	--Farm Esmt Agricultural Checklist Source Type
	-- Drop Table
	...
	--Farm Esmt Agricultural Enterprise Checklist
	...
	--Farm Esmt App Agricultural and Production
    ...
    --Farm Esmt App Admin Offer Cost
	...
	--Farm Esmt App Admin ClosingDocsStatus
	...
	--Farm Esmt AppAdmin Cost Details
	...
	--Farm Esmt App Admin Appraisal Reports
	...
	--Farm EsmtAppAdmin StructNonAgriWetlands
	...
	--Farm MunicipalityBlockLotParcel
