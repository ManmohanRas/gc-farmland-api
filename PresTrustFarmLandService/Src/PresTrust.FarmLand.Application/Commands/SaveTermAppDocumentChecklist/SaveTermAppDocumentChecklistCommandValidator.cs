...
public class SaveTermAppDocumentChecklistCommandValidator : AbstractValidator<SaveTermAppDocumentChecklistCommand>
{
    /// <summary>
    /// create rules for attributes
    /// </summary>
    public SaveTermAppDocumentChecklistCommandValidator()
    {
...
public class DocumentValidator : AbstractValidator<TermDocumentsViewModel>
{
