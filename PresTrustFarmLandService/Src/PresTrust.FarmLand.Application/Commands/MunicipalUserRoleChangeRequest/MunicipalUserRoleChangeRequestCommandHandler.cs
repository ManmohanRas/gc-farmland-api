...
public class MunicipalUserRoleChangeRequestCommandHandler :  BaseHandler , IRequestHandler<MunicipalUserRoleChangeRequestCommand,bool>
{
    ...
    public MunicipalUserRoleChangeRequestCommandHandler(
            IMapper mapper,
