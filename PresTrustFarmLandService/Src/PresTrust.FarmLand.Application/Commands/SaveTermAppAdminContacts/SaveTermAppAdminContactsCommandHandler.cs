...
public class SaveTermAppAdminContactsCommandHandler : BaseHandler, IRequestHandler<SaveTermAppAdminContactsCommand, bool>
{
    ...
    public SaveTermAppAdminContactsCommandHandler
        (
        IMapper mapper,
    ...
    public async Task<bool> Handle(SaveTermAppAdminContactsCommand request, CancellationToken cancellationToken)
    {
