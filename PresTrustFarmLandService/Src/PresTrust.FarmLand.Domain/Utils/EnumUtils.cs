namespace PresTrust.FarmLand.Domain.Utils;
...
public class EnumUtils
{
    ...
    public static string GetDescription<TEnum>(string value) where TEnum : struct
    {
        Type eType = typeof(TEnum);
        string eName = Enum.GetName(eType, value);
        if (eName != null)
        {
